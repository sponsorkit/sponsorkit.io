...
export type GetPullRequestsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', edges?: Maybe<Array<Maybe<{ __typename?: 'SearchResultItemEdge', node?: Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest', number: number, mergedAt?: Maybe<any>, title: string, createdAt: any, state: PullRequestState, author?: Maybe<{ __typename?: 'Bot', login: string } | { __typename?: 'EnterpriseUserAccount', login: string } | { __typename?: 'Mannequin', login: string } | { __typename?: 'Organization', login: string } | { __typename?: 'User', login: string }> } | { __typename?: 'Repository' } | { __typename?: 'User' }> }>>> } };


export const GetPullRequestsDocument = gql`
    query getPullRequests($query: String!) {
  search(type: ISSUE, last: 10, query: $query) {
    edges {
      node {
        ... on PullRequest {
          author {
