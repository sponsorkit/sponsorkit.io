...
export type GetMergedPullRequestsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMergedPullRequestsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', edges?: Maybe<Array<Maybe<{ __typename?: 'SearchResultItemEdge', node?: Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest', number: number, mergedAt?: Maybe<any>, baseRefName: string, headRefName: string, author?: Maybe<{ __typename?: 'Bot', login: string } | { __typename?: 'EnterpriseUserAccount', login: string } | { __typename?: 'Mannequin', login: string } | { __typename?: 'Organization', login: string } | { __typename?: 'User', login: string }> } | { __typename?: 'Repository' } | { __typename?: 'User' }> }>>> } };


export const GetMergedPullRequestsDocument = gql`
    query getMergedPullRequests {
  search(
    type: ISSUE
    first: 10
    query: "repo:github/linguist is:pr updated:>2020-07-11T23:57:00Z"
  ) {
    edges {
      node {
        ... on PullRequest {
...
/**
 * __useGetMergedPullRequestsQuery__
 *
 * To run a query within a React component, call `useGetMergedPullRequestsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMergedPullRequestsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMergedPullRequestsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetMergedPullRequestsQuery(baseOptions?: Apollo.QueryHookOptions<GetMergedPullRequestsQuery, GetMergedPullRequestsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMergedPullRequestsQuery, GetMergedPullRequestsQueryVariables>(GetMergedPullRequestsDocument, options);
      }
export function useGetMergedPullRequestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMergedPullRequestsQuery, GetMergedPullRequestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMergedPullRequestsQuery, GetMergedPullRequestsQueryVariables>(GetMergedPullRequestsDocument, options);
        }
export type GetMergedPullRequestsQueryHookResult = ReturnType<typeof useGetMergedPullRequestsQuery>;
export type GetMergedPullRequestsLazyQueryHookResult = ReturnType<typeof useGetMergedPullRequestsLazyQuery>;
export type GetMergedPullRequestsQueryResult = Apollo.QueryResult<GetMergedPullRequestsQuery, GetMergedPullRequestsQueryVariables>;